...
p_single_eq_path = "/home/emmanuel/ecastillo/dev/associator/GPA/project/delaware_west/dataset/p_single_eq2.csv"
s_single_eq_path = "/home/emmanuel/ecastillo/dev/associator/GPA/project/delaware_west/dataset/s_single_eq2.csv"
single_eq_path = "/home/emmanuel/ecastillo/dev/associator/GPA/project/delaware_west/dataset/single_eq2.csv"
proj = "EPSG:3857"

df = pd.read_csv(stations_path)
stations = Stations(data=df, xy_epsg=proj)

df = pd.DataFrame.from_dict({"latitude":[31.64771000],
                             "longitude":[-104.0501000000000],
                            #  "depth":[6.903000000000000],
                             "depth":[1.900000000000],
                            #  "origin_time":[dt.datetime(2022,11,16,21,32,48.4819999)]
                             "origin_time":["2023-12-07T04:05:49.408999999999999Z"]
                             })
