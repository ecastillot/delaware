...
def plot_distance_depth(proj):
    """
    Plot distance vs depth with discrete color scaling for magnitude.

    Args:
        proj (pd.DataFrame): DataFrame containing projection data with 'distance', 'depth', and 'magnitude'.
    ...
    scatter = ax.scatter(proj['distance'], proj['depth'],
...
def main(df, region,filter_dates=None,output=None):
    ...
    fig, ax = plot_distance_depth(proj)
...
if __name__ == "__main__":
    ...
    # filter_dates = (dt.datetime(2017,1,1),dt.datetime(2020,2,29) ) #x1
    ...
    output= "/home/emmanuel/ecastillo/dev/delaware/profiles_delaware/x4.png"
