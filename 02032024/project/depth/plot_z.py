...
sns.scatterplot(x="longitude", y="depth", hue="Author", palette=["blue", "red"], data=df, ax=axes[0], marker="+")
...
sns.scatterplot(x="latitude", y="depth", hue="Author", palette=["blue", "red"], data=df, ax=axes[1], marker="+")
